...
from .interfaces import IEnviador, IRecibidor, IListador # Importación relativa
from modelos.objetos import Mensaje, Carpeta
...
class ServidorCorreo:
    ...
    def registrar_usuario(self, usuario: "Usuario"):
        ...
        print(f"Usuario {usuario.obtener_nombre()} registrado en el servidor {self._nombre_servidor}.")
...
class Usuario(IEnviador, IRecibidor, IListador):
    ...
    def enviar_mensaje(self, destinatario: str, asunto: str, cuerpo: str, es_urgente: bool = False) -> Mensaje:
        mensaje = Mensaje(self._email, destinatario, asunto, cuerpo, es_urgente)
